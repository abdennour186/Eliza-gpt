...
class VerbResponseHandlerTest {
    VerbResponseHandler verbResponseHandler;
    @Mock
    BestClubHandler bestClubHandlerMock;
    @BeforeEach
    public void setUp(){
    ...
    void generateResponse() {
        ...
        assertTrue(response.equals(expectedResponse1) || response.equals(expectedResponse2) || response.equals(expectedResponse3));
    ...
    void firstToSecondPerson() {
        ...
        assertEquals("vous savez nager", verbResponseHandler.firstToSecondPerson("je sais nager"));
        assertEquals("vous devez étudier", verbResponseHandler.firstToSecondPerson("je dois étudier"));
